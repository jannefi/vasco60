...
def main() -> int:
    ...
    ap.add_argument(
        "--input-glob",
        default="stages/stage_S2_SCOS.csv",
        help="Glob (relative to run-dir) for input stage CSV(s). Default: stages/stage_S2_SCOS.csv",
    )
    ap.add_argument("--stage", default="S3", help="Stage label used in output filenames. Default: S3")
